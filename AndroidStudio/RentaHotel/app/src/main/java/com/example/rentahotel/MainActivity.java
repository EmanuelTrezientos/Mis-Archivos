...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TidCliente = (TextView) findViewById(R.id.TidCliente);
        ...
        Benviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Hotel MostrarTotal = new Hotel(Integer.parseInt(TidCliente.getText().toString()), Tnombre.getText().toString(), Ttelefono.getText().toString(), Integer.parseInt(TidHotel.getText().toString()),Integer.parseInt(Thabitacion.getText().toString()), TfechaEntrada.getText().toString(), TfechaSalida.getText().toString(), Integer.parseInt(TvalorDia.getText().toString()), Integer.parseInt(Tdias.getText().toString()),"activo");
