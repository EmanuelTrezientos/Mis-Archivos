...
import com.example.basedatossqlite.entidades.Contactos;
...
public class DbContactos extends DbHelper {
    ...
    // MODELO VISTA CONTROLADOR: MODELO LE TRANSFIERE A CONTROLADOR Y ESTE A VISTA //
    public long insertarContacto(String nombre, String telefono, String correo_electronico) {
    // METODO SET ENCARGADO DE MODIFICAR//
        long id = 0;
    ...
    public ArrayList<Contactos> mostrarContactos() {
        ...
        // RAW ES FILAS, ESTE ES UN METODO BUSCAR FILAS //
